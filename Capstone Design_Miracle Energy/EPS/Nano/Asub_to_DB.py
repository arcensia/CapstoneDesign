...
def inputDB(data):
    ...
    # STEP 4:
    sql = "INSERT INTO Asensertable (gas, volt, Tcurrent, Acurrent) VALUES (%s,%s,%s,%s)"
    cur.execute(sql,(a,b,c,d))
    #cur.executemany("INSERT INTO Asensertable (gas, volt, Tcurrent, Acurrent) VALUES (%d,%d,%d,%d)",(int(a),int(b),int(c),int(d)))   
    con.commit()
